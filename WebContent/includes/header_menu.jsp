                        ...
                        <div class="row">
                            <div class="col-sm-7">
                                <div class="call-us top-bar-block">
                                    ...
                                    <span>
                                         (51)30451979 / (51)8488183(oi)
                                    </span>
                                </div>
                                <div class="mail-us top-bar-block">
                                    <i class="icon-email"></i>                            
                                    <span>
                                        E-mail: digitalavendas@gmail.com
                                    </span>                            
                                </div>
                            ...
                            <div class="col-sm-5">
                                ...
                                <div class="social-icons">
                                    <ul>
                                        <li>
                                            <a href="https://www.facebook.com/pages/Digital-A/1453245794968245?fref=ts" target="_blank" class="social-media-icon facebook-icon" data-original-title="facebook">facebook</a>
                                        </li>
                                        <li>
